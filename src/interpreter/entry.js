...
if (!entryPath) {
    throw new Error('Please specify the entry file path with --entry /path/to/file');
}

if (!outputPath) {
    throw new Error('Please specify the output directory path with --out /path/to/directory');
}
